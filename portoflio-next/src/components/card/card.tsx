...
export const ProjectCard: React.FC<CardProps> = ({ title, description, icon, image, buttons }) => {
  return (
    <div className="w-[360px] sm:w-[80%] h-[70%] sm:h-[100%] duration-500 group overflow-hidden relative bg-slate-50 dark:bg-neutral-800 text-neutral-50 border font-poppins border-white p-4 flex flex-col justify-evenly rounded-2xl">
      ...
      <div className="z-10 flex flex-col justify-evenly w-full h-full items-start">
        <div className="relative w-full h-[100%] sm:h-40 mb-4">
