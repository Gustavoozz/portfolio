export const AcademicTimeLine = () => {
  return (
    <div className="container bg-transparent mx-auto w-full h-full">
      <div className="relative wrap overflow-hidden p-10 before:absolute before:content-[''] before:w-1 before:bg-white before:h-full before:left-1/2 before:transform before:-translate-x-1/2">

    
        <div  className="mt-10 mb-10 flex justify-between items-center w-full">
          <div  className="order-1 w-5/12"></div>

          <div  className="font-poppins z-20 flex items-center justify-center order-1 bg-white shadow-xl w-10 h-10 rounded-full">
            <h1 className="text-black font-semibold text-lg">1</h1>
          </div>

          <div data-aos="fade-right" className="order-1 bg-[#262626] rounded-2xl shadow-xl w-5/12 px-4 py-4 flex flex-col items-center text-center gap-4">
            <img
            ...
            <div className="font-poppins flex flex-col">
              ...
              <h5 className="text-lg leading-snug tracking-wide text-gray-500">
        ...
        <div className="mb-20 flex justify-between items-center w-full">
          <div data-aos="fade-left" className="order-1 bg-[#262626] rounded-2xl shadow-xl w-5/12 px-4 py-4 flex flex-col items-center text-center gap-4">
            <img
              className="rounded-xl max-w-[80px] h-auto"
          ...
          <div className="font-poppins z-20 flex items-center justify-center order-1 bg-white shadow-xl w-10 h-10 rounded-full">
            <h1 className="text-black font-semibold text-lg">2</h1>
          </div>
